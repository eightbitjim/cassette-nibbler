...
public class AtariByteFrame {
    public static final int ERROR = -1;
    public static final int MORE_BITS_NEEDED = -2;

    private static final int ONE_BIT = PulseStreamConsumer.MEDIUM_PULSE;
    private static final int ZERO_BIT = PulseStreamConsumer.SHORT_PULSE;

    private static final int BITS_IN_FRAME = 10;
    private static final int START_BIT_POSITION = 0;
    private static final int STOP_BIT_POSTION = 9;
    ...
    private void checkForStartBit(int bit) {
        if (bit != ZERO_BIT) {
            resetByte();
            error = true;
            pushStringToPulseStream(" SKIP INVALID PULSE\n");
            return;
        }
