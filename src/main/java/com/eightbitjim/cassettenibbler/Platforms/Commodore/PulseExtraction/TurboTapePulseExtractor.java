...
public class TurboTapePulseExtractor implements PulseStreamProvider, IntervalStreamConsumer {

    private static final double NANOSECOND = 1.0 / 1000000000.0;
    private double shortPulseLength =  NANOSECOND * 50000.0 * 2.0;
    private double mediumPulseLength = NANOSECOND * 113378.0 * 2.0;
    private double longPulseLength =   NANOSECOND * 158730.0 * 2.0;
    ...
    public TurboTapePulseExtractor(boolean bottomHalfPulseExtractionOnly) {
