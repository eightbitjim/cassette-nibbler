...
public class MSXTapeFile extends TapeFile {
    List<MSXTapeBlock> blocks;
    ...
    public void addBlock(MSXTapeBlock block) {
        blocks.add(block);
    }
    ...
    public String getFilename() {
        ...
        if (headerBlockDescribesFileOfType() == MSXTapeBlock.BlockType.MACHINE_CODE)
    ...
    public boolean isOrphanHeader() {
        return headerBlockDescribesFileOfType() == MSXTapeBlock.BlockType.UNKNOWN;
    }

    private MSXTapeBlock.BlockType headerBlockDescribesFileOfType() {
        if (blocks.size() < 1)
            return MSXTapeBlock.BlockType.UNKNOWN;
        else
            return blocks.get(0).getTypeOfNextBlockIfThisIsAHeader();
    }

    public MSXTapeBlock.BlockType nextBlockType() {
        if (blocks.size() < 1)
            return MSXTapeBlock.BlockType.HEADER;
        else
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MSXTapeFile))
            return false;

        MSXTapeFile other = (MSXTapeFile) o;
