...
package com.eightbitjim.cassettenibbler.Platforms.MSX.PulseExtraction;
...
public class MSXPulseExtractor implements IntervalStreamConsumer, PulseStreamProvider {

    public enum Baud { BAUD_1200, BAUD_2400 }
    ...
    public MSXPulseExtractor(Baud baud) {
        interval = new Transition();
        consumers = new LinkedList<>();
        setUpPulseLengths(baud);
        currentTimeIndex = 0;
    ...
    private void setUpPulseLengths(Baud baud) {
        ...
        shortPulseLength = 1.0 / 1200.0 / 2.0 * multiplier;
