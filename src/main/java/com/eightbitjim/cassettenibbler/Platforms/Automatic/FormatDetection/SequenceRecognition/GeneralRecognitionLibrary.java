...
public class GeneralRecognitionLibrary implements RecognitionLibrary {
    List<Recogniser> recogniserList;

    public GeneralRecognitionLibrary() {
        recogniserList = new LinkedList<>();
        recogniserList.add(new c64MachineCodeRecogniser());
        recogniserList.add(new c16plus4MachineCodeRecogniser());
        recogniserList.add(new c64BasicRecogniser());
        recogniserList.add(new RomanTextRecogniser());
        recogniserList.add(new zxSpectrumMachineCodeRecogniser());
    }
