...
import com.eightbitjim.cassettenibbler.Platforms.Automatic.FormatDetection.SequenceRecognition.Vic20RecognitionLibrary;
...
public class Vic20TurboLoadExtractionPlatform extends Platform {
    ...
    public Vic20TurboLoadExtractionPlatform() {
        super();

        name = "vic20turboload";
        description = "Analysis of pulses to automatically determine loading format, based on the assumption that it is a Vic 20 turbo loader";
    }
    ...
    public void initialise(String channelName) {
        ...
        pulseExtractor = new AutomaticPulseExtractor(2, channelName);
        fileExtractor = new FileCombinerWithThreashold(new Vic20RecognitionLibrary(), channelName);
    }
