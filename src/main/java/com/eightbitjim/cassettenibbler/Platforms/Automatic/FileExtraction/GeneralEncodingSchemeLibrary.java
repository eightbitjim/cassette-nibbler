...
public class GeneralEncodingSchemeLibrary {
    ...
    public GeneralEncodingSchemeLibrary() {
    ...
    private void addEncodingSchemesToList() {
        for (int padding = 0; padding < 6; padding++) {
            ...
            schemes.add(new EncodingScheme(new char[]{SHORT, MEDIUM}, new char[]{MEDIUM, SHORT}, padding, true));
            schemes.add(new EncodingScheme(new char[]{MEDIUM, SHORT}, new char[]{SHORT, MEDIUM}, padding, true));
            ...
            schemes.add(new EncodingScheme(new char[]{MEDIUM}, new char[]{SHORT, SHORT}, padding, true));
            schemes.add(new EncodingScheme(new char[]{SHORT, SHORT}, new char[]{MEDIUM}, padding, true));
            ...
            schemes.add(new EncodingScheme(new char[]{SHORT, MEDIUM}, new char[]{MEDIUM, SHORT}, padding, false));
            schemes.add(new EncodingScheme(new char[]{MEDIUM, SHORT}, new char[]{SHORT, MEDIUM}, padding, false));
            ...
            schemes.add(new EncodingScheme(new char[]{MEDIUM}, new char[]{SHORT, SHORT}, padding, false));
            schemes.add(new EncodingScheme(new char[]{SHORT, SHORT}, new char[]{MEDIUM}, padding, false));
        }
    }
}
